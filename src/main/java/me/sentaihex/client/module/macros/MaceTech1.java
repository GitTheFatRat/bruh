...
public class MaceTech1 extends ClientModule {
    ...
    private int slotPearl      = KeyEvent.VK_V;
    ...
    public void execute() throws InterruptedException {
        InputSimulator.pressKey(InputSimulator.toWinVK(slotPearl));
        Thread.sleep(delay1);
        InputSimulator.rightClick();
        Thread.sleep(50);

        InputSimulator.pressKey(InputSimulator.toWinVK(slotWindCharge));
        Thread.sleep(delay2);
        InputSimulator.rightClick();
    }
